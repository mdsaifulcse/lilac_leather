                        ...
                        <div class="kt-portlet__body">
                            ...
                            <div class="row">
                                <div class="form-group col-md-9 col-lg-9 inputSec">
                                    <div class="row">
                                        <div class="col-md-8">
                                            ...
                                            {!! Form::text('name', $value=old('name'), array('placeholder' => __('admin.Product Title'),'class' => 'form-control','required'=>true)) !!}
                                    ...
                                    <div>
                                        ...
                                        <div class="">
                                            {!! Form::textArea('description', $value=old('description'), ['rows'=>5,'placeholder' => '','class' => 'form-control textarea','required'=>false]) !!}
                                    ...
                                    <div>
                                        <label for="example-text-input" class="col-form-label">{{__('admin.Specification')}}<sup class="text-danger">*</sup></label>
                                        <div class="">
                                ...
                                <div class="form-group col-md-3 col-lg-3 dropdownSec">
                                    ...
                                    <div class="">
                                        <label for="example-text-input" class="col-form-label">{{_('Language')}} <sup class="text-danger">*</sup></label>
                                        {!! Form::select('language_id',$languageLists,[], ['placeholder' => '--Select Language --','class' => 'form-control select2tags','required'=>false]) !!}
                                    ...
                                    <div class="">
                                        ...
                                        {!! Form::select('pack_size_unit_id',$packSizeUnitLists,[], ['placeholder' => '--Select Size --','class' => 'form-control select2tags','required'=>false]) !!}
                                    ...
                                    <div class="">
                                        ...
                                        {!! Form::select('country_id',$countryLists,[], ['placeholder' => '--Select Colour --','class' => 'form-control select2tags','required'=>false]) !!}
                                    ...
                                    <div class="">
                                        ...
                                        {!! Form::select('gender',$gender,[], ['placeholder' => '--Select Gender --','class' => 'form-control select2tags','required'=>true]) !!}
