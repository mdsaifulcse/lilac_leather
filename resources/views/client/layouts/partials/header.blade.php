                        ...
                        <form class="form form-login" action="{{route('login')}}" method="POST" id="login-form">
                            ...
                            <fieldset class="fieldset login" data-hasrequired="* Required Fields">
                                <div class="field email required email-input">
                                    <div class="control">
                                        <input type="text" name="auth" autocomplete="off" id="email" class="input-text" required title="Email / Mobile" placeholder="Email / Mobile">
                                        @if ($errors->has('auth'))
                                            <span class="help-block">
                                            <strong class="text-warning text-center">{{ __('frontend.Credentials does not match') }}</strong>
                                        </span>
                                        @endif
                                        @error('email')
