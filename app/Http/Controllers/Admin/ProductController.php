...
class ProductController extends Controller
{
    ...
    public function create()
    {
        ...
        $packSizeUnitLists=DataLoad::packSizeUnitList();
        ...
        return view('admin.'.Route::currentRouteName(),
            compact('title','status','yesNoStatus','max_serial','countryLists','languageLists','packSizeUnitLists','gender','vatTaxes','brands',
...
//            }
    ...
    public function edit($id)
    {
        ...
        $max_serial=Product::max('serial_num');
        return view('admin.'.Route::currentRouteName(),
            compact('title','status','yesNoStatus','product','max_serial','bookAuthors','countryLists','languageLists','packSizeUnitLists','gender',
