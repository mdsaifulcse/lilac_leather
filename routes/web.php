...
Route::post('/login/staff', 'App\Http\Controllers\LoginController@staffLogin');
Route::post('/login/admin', 'App\Http\Controllers\LoginController@adminLogin');
...
Route::group(['middleware' => ['auth'],'namespace'=>'App\Http\Controllers\Menu','prefix' => 'admin'], function() {
...
Route::group(['middleware' => ['auth'],'namespace'=>'App\Http\Controllers\Spatie','prefix' => 'admin'], function() {
...
Route::group(['middleware' => ['auth'],'namespace'=>'App\Http\Controllers\OrderDelivery','prefix' => 'order-delivery'], function() {
...
Route::get('/register.html', 'App\Http\Controllers\RegisterController@showRegistrationForm');

Route::post('news-letter-save','App\Http\Controllers\Admin\NewsLetterController@store');

Route::group(['namespace'=>'App\Http\Controllers\Client\userResource','middleware' => ['auth','client']], function() {
...
Route::group(['namespace'=>'App\Http\Controllers\Client','middleware' => ['auth','client']], function() {
